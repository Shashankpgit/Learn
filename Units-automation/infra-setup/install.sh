...
# Function to install Finternet
install_finternet() {
    echo "installation has started for $provider.."
    case "$provider" in
        aws)
            terragrunt init
            ...
            ;;
        gcp)
            echo "teragrunt ----init--- starts here"
            terragrunt init
            echo "teragrunt ----plan--- starts here"
            terragrunt plan -var-file=vars/terraform.tfvars
            echo "teragrunt ----apply--- starts here"
            terragrunt apply -var-file=vars/terraform.tfvars --auto-approve
            ;;
        *)
...
# WARNING: This will destroy all resources created by Finternet
# Execute this only if you want to decommission Finternet completely
destroy_finternet() {
    echo "Destroying Finternet for $provider..."
    terragrunt destroy -var-file=vars/terraform.tfvars --auto-approve
    echo "Finternet has been successfully destroyed."
}
