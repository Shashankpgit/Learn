...
output "public_subnetwork_secondary_range_name" {
  description = "Name of the secondary range of the public subnetwork"
...
output "public_services_secondary_cidr_block" {
  description = "CIDR block of the services secondary range of the public subnetwork"
...
output "public_services_secondary_range_name" {
  description = "Name of the services secondary range of the public subnetwork"
...
output "private_subnetwork_secondary_range_name" {
  description = "Name of the secondary range of the private subnetwork"
